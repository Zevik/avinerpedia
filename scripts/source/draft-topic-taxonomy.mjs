...
const TREE = {
  'הלכה': {
    'שבת': ['שבת', 'שבת ויום טוב', 'שבת - הלכה', 'שבת ויום טוב - הלכה'],
    'כשרות ומזון': ['כשרות ומזון', 'כשרות', 'בשר וחלב', 'כשרות - הלכה', 'טבילת כלים', 'בישול עכו"ם', 'תרומות ומעשרות'],
    'צניעות': ['צניעות', 'צניעות - הלכה'],
    'טהרת המשפחה': ['טהרת המשפחה', 'מקווה- הלכה', 'טהרת המשפחה - הלכה'],
    'אבלות': ['אבלות', 'אבילות', 'אבלות - הלכה'],
    'דיני ממונות': ['דיני ממונות', 'חושן משפט', 'ריבית', 'הלכות חברה'],
    'הלכות ציבור': ['הלכות ציבור', 'בית כנסת - הלכה', 'שליח ציבור'],
    'מצוות ומנהגים': ['ציצית ותפילין - הלכה', 'ציצית ותפילין', 'מזוזה', 'מנהגים', 'הלכות שונות', 'שונות - הלכה', 'עניינים שונים'],
    'רפואה ופיקוח נפש': ['פיקוח נפש', 'בריאות', 'רפואה', 'הצלת נפשות - הלכה', 'תרומת איברים'],
    'גיור': ['גיור', 'גיור - הלכה'],
    'פסיקת הלכה': ['פסיקת הלכה'],
  },
  'מועדים': {
    'ימים נוראים': ['ראש השנה', 'יום כיפור', 'עשרת ימי תשובה', 'סליחות', 'אלול', 'צום גדליה'],
    'סוכות ושמחת תורה': ['סוכות', 'שמחת תורה', 'שמיני עצרת - שמחת תורה', 'חול המועד', 'סוכה'],
    'חנוכה': ['חנוכה'],
    'ט"ו בשבט': ['ט"ו בשבט'],
    'פורים': ['פורים', 'תענית אסתר', 'פרשת זכור'],
    'פסח וספירת העומר': ['פסח', 'ספירת העומר', 'שובבי"ם'],
    'ל"ג בעומר': ['ל"ג בעומר'],
    'שבועות': ['שבועות'],
    'בין המצרים ותעניות': ['בין המצרים', 'תשעה באב', 'י"ז בתמוז', 'עשרה בטבת', 'צומות ותעניות', 'זכר לחורבן', 'הלכות תענית', 'ט"ו באב'],
  ...
  'אמונה': {
    ...
    'דתות ועמים': ['דתות הגויים', 'נצרות', 'גויים ביהדות', 'עבודה זרה', 'חוקות הגויים'],
  ...
  'תורה ולימוד': {
    ...
    'קבלה וחסידות': ['לימוד קבלה', 'מקובלים', 'תורת רבי נחמן מברסלב'],
    'מדרשים ואגדות': ['מדרשים ואגדות'],
    'ספרים': ['ספרים', 'ספרים שונים'],
  },
  'תפילה': {
    'הלכות תפילה': ['תפילה - הלכה', 'תפילה - הלכות', 'קריאת שמע', 'תפילת שמונה עשרה', 'מנחה ומעריב', 'קריאת התורה', 'ברכת כהנים'],
    'ביאור התפילה': ['באור תפילה', 'השפעת התפילה', 'שאלות כלליות - תפילה'],
    'ברכות': ['ברכות', 'ברכות - הלכה', 'תפילת הדרך'],
  },
  'מדינת ישראל': {
    'ארץ ישראל': ['ארץ ישראל', 'התיישבות', 'אהבת הארץ'],
    'צה"ל וביטחון': ['צה"ל', 'הלכות חגים לחייל', 'מוסר במלחמה', 'חטופים'],
    'פוליטיקה ובחירות': ['פוליטיקה', 'פוליטיקה ובחירות', 'בחירות'],
    ...
    'הר הבית ובית המקדש': ['הר הבית', 'בית המקדש', 'הכותל המערבי'],
  ...
  'מוסר ומידות': {
    'מידות': ['מידות', 'עבודת המידות'],
    'שמירת הלשון': ['שמירת הלשון'],
    'מוסר חברתי': ['מוסר חברתי', 'דרך ארץ', 'חסד', 'הכרת הטוב'],
    'מוסר בחיי הפרט': ['מוסר בחיי הפרט', 'מוסריות', 'חיי הפרט'],
  },
  'זוגיות ומשפחה': {
    'שידוכים והכנה לחתונה': ['שידוכים והכנה לחתונה', 'שידוכים', 'הכנה לחתונה', 'אירוסין'],
    'חיי זוגיות': ['זוגיות', 'עבודת הזוגיות', 'זוגיות במקורות', 'חינוך זוגי', 'אהבה', 'שמירת התא המשפחתי'],
  ...
  'חינוך': {
    ...
    'חינוך לתורה ומצוות': ['חינוך לתורה ומצוות', 'חינוך במקורות'],
...
const CORE_ALIASES = { 'תורה': 'תורה ולימוד' };
...
const FORMATS = { 'מאמרים מיוחדים': 'פורמט: מאמרים מיוחדים', 'ציוצים': 'פורמט: ציוצים', 'שירים': 'פורמט: שירים' };
